...
#If there are not libraries then you can install it by yourself.
...
for(i in 1:10) {
		...
		# Neural Network
		# build model
		#Trace will help with not printing unnecessary data.
...
#This will print output for all the files, step by step.
cat("\n\n")
